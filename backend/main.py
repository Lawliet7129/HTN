...
from cohere_service import beautify_text, get_text_from_image_cohere
...
async def convert_image(file: UploadFile = File(...)) -> Dict[str, str]:
    ...
    try:
        ...
        raw_text = get_text_from_image(contents) # Use Tesseract OCR to extract raw text from image
